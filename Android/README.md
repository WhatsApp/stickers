...
Importantly, when naming your app, you must follow [WhatsApp Brand Resources](https://whatsappbrand.com/) to make sure you're using their brand name and logos correctly. For example, including the word "WhatSapp" in your app's name may result in your app suspended, as it should only be spelt "WhatsApp". WhatsApp can also launch the Google Play Store and perform a search for other sticker pack apps. To help your app appear in this list, also add the keyword WAStickerApps to app's description when setting up your app in the Google Play Store console. You can use additional keywords, but make sure you at least use this one.
